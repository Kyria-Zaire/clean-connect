...
| [PRD-002](PRD-002-missions-geolocalisation.md) | `missions-geolocalisation` | Missions & Géolocalisation (entity, états, scheduling, matching PostGIS) | 🔵 `DRAFT` (Discover en cours) | S2 | CTO | `senior-dev` + `architecte-api` + `mobile` | — |
...
| **Sprint 2** | PRD-002 Missions & Géolocalisation | 🔵 Discover en cours | [PRD-002](PRD-002-missions-geolocalisation.md) |
